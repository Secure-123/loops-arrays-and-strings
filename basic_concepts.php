...
e) Sort this larger list of countries into reverse alphabetical order (do some research into sorting functions) and output the result.
*/
...
b) Use the strlen() function to output the length of the strin
